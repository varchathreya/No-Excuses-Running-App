...
export default function RunDetails() {
  ...
  const { activities, workouts, regimenId } = useApp();
  ...
  const linkedWorkout = activity.workoutId && (activity.regimenId ?? 1) === regimenId
    ? workouts.find((item) => item.id === activity.workoutId)
    : undefined;

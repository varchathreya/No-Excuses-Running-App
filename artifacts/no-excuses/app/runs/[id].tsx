...
const local = StyleSheet.create({ metrics: { borderRadius: 20, padding: 18, marginTop: 18, gap: 18 }, actions: { marginTop: 10 }, label: { fontFamily: 'Inter_700Bold', fontSize: 10, letterSpacing: 1 }, value: { fontFamily: 'Inter_700Bold', fontSize: 22, marginTop: 4 } });
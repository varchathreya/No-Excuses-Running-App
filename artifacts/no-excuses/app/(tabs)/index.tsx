...
const local = StyleSheet.create({ quoteBox: { borderRadius: 24, padding: 22, minHeight: 138, justifyContent: 'center', gap: 14, marginBottom: 18 }, quote: { fontFamily: 'Inter_700Bold', fontSize: 24, lineHeight: 30, letterSpacing: -.5 }, statRow: { flexDirection: 'row', justifyContent: 'space-between', paddingVertical: 6, marginBottom: 24 }, statItem: { flex: 1 }, stat: { fontFamily: 'Inter_700Bold', fontSize: 22 }, statLabel: { fontFamily: 'Inter_400Regular', fontSize: 11, marginTop: 3 }, next: { minHeight: 150, borderRadius: 22, padding: 20, flexDirection: 'row', justifyContent: 'space-between', alignItems: 'center', marginBottom: 16 }, nextCopy: { flex: 1, alignItems: 'flex-start' }, nextOverline: { color: '#111315', fontFamily: 'Inter_700Bold', fontSize: 11, letterSpacing: 1 }, nextTitle: { color: '#111315', fontFamily: 'Inter_700Bold', fontSize: 21, marginVertical: 10 }, startButton: { minHeight: 38, borderRadius: 11, borderWidth: 1.5, borderColor: '#111315', paddingHorizontal: 12, flexDirection: 'row', alignItems: 'center', gap: 7 }, startText: { fontFamily: 'Inter_700Bold', fontSize: 12 }, playButton: { width: 52, height: 52, borderRadius: 26, borderWidth: 2, borderColor: '#111315', alignItems: 'center', justifyContent: 'center' }, planCard: { borderRadius: 22, padding: 18, borderWidth: 1, marginBottom: 16 }, planHeader: { flexDirection: 'row', justifyContent: 'space-between', alignItems: 'center' }, planTitle: { fontFamily: 'Inter_700Bold', fontSize: 16, marginBottom: 2 }, percent: { fontFamily: 'Inter_700Bold', fontSize: 20 }, track: { height: 9, borderRadius: 6, marginVertical: 16, overflow: 'hidden' }, fill: { height: '100%', borderRadius: 6 }, scheduleLink: { minHeight: 42, borderRadius: 12, borderWidth: 1, flexDirection: 'row', alignItems: 'center', justifyContent: 'center', gap: 8 }, scheduleText: { fontFamily: 'Inter_700Bold', fontSize: 13 } });